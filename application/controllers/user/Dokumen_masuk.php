...
class Dokumen_masuk extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['masuk_dok'] = $this->db->get('tbl_dok_masuk')->result();
	...
	public function get_list()
	{
		...
		foreach ($list as $li) {
			...
			// $print = '<button type="button" class="badge badge-info" onclick="printJS('. base_url('assets/' . $li['path_folder'] . '/' . $li['file_dokumen']) .')"><i class="fa fa-print"></i></button>';
