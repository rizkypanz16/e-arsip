...
$route['user/page/laporan-dokumen-masuk'] = 'user/laporan_dok_masuk';

// Laporan Masuk
$route['user/page/detail_masuk'] = 'user/Laporan_dok_masuk/detail_masuk';

// Laporan Keluar
$route['user/page/detail_keluar'] = 'user/Laporan_dok_keluar/detail_keluar';
