...
<section class="content">
    <div class="container mt-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-envelope-open text-dark"></i><strong class="text-dark">  Detail Laporan Dokumen Keluar</strong></li>
            </ol>
        </nav>
                    ...
                    <table class="table table-striped w-100 dt-responsive nowrap mb-5" id="dataTable">
                        ...
                        ?>
                            <tr style="font-size: 13px;">
                                <td><?= $no++ ?></td>
                                <td><strong><?= $values->perihal ?></strong><hr><?= "No : ".$values->no_dokumen ?><br><?= substr($values->unit_tujuan, 15, -3) ?><br><?= "Lampiran : ".$values->lampiran ?></td>
