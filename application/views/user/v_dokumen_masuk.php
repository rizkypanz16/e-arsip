	...
	<div class="content-wrapper">
		...
		<section class="content">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item active" aria-current="page"><i class="fas fa-envelope-open text-dark mr-2"></i><strong class="text-dark">  Data Surat Masuk</strong></li>
				</ol>
			</nav>
			<div class="container-fluid">
				<div class="row">
									...
									<?php 
										...
										?>
											<tr style="font-size: 12px; ">
												...
												<td><strong><?= "Perihal : ". $values->perihal ?></strong><hr>Dari : <?= $values->dari ?> <br>No Surat : <?= $values->no_dokumen ?></td>
												<td>
													<?php
														if($values->tgl_disposisi != null){
															echo '<p class="text-success my-0"><i class="fa fa-share"></i> Didisposisikan</p>';
															echo "Pada : ". $values->tgl_disposisi;
														}else{
															echo '<p class="text-info"><i class="fa fa-envelope-open"></i> Diterima</p>';
														}
													?>
												</td>
												<td><?= substr($values->tgl_dokumen, 0, 10) ?></td>
												<td>
													...
													<span class="badge badge-info" style="cursor: pointer" onclick="view(<?= $values->id_dokumen ?>)"><i class="fa fa-eye"></i></span><br>
