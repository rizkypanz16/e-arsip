...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item active" aria-current="page"><i class="fas fa-users text-dark"></i><strong class="text-dark">  Data Tujuan</strong></li>
			</ol>
		</nav>
			<div class="container-fluid">
				<div class="row">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Form Tujuan Dokumen</h5>
				...
				<form id="form" autocomplete="off">
					...
					<div class="form-group row">
						<div class="offset-2 col-sm-6">
							<span class="btn btn-danger btn_save" onclick="save_form()"></span>
						</div>
					</div>
				</form>
			</div>
